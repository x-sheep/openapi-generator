...
internal class URLSessionRequestBuilder<T>: RequestBuilder<T>, @unchecked Sendable {
    ...
    required internal init(method: String, URLString: String, parameters: [String: ParameterField]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: PetstoreClientAPIConfiguration = PetstoreClientAPIConfiguration.shared) {
...
internal protocol ParameterEncoding {
    func encode(request: URLRequest, with parameters: [String: ParameterField]?) throws -> URLRequest
}
    ...
    func encode(request: URLRequest, with parameters: [String: ParameterField]?) throws -> URLRequest {
        ...
        for (key, value) in parameters {
            for value in value.arrayValue {
                ...
                case .array:
                    fatalError("Unexpected nested array")
                }
            }
        }
