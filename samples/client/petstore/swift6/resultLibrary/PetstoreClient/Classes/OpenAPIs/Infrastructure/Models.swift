...
public enum ParameterField: Sendable {
    case string(String)
    case array([ParameterField])
    case data(Data)
    case file(URL)
}

extension ParameterField {
...
extension ParameterField: ExpressibleByArrayLiteral {
    public init(arrayLiteral elements: ParameterField...) {
        self = .array(elements)
    }
}
